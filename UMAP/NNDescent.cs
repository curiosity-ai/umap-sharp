...
namespace UMAP
{
    internal static class NNDescent<T> where T : IUmapDataPoint
    {
        ...
        /// </summary>
        public static NNDescentFn MakeNNDescent(DistanceCalculation<RawVectorArrayDataPoint> distanceFn, IProvideRandomValues random)
        {
